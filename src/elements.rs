...
const ELEMENTCOLOURS: [Color; 119] = [
    ...
    Color::CYAN,                  // Helium,He,2
    Color::BLACK,                 // Lithium,Li,3
    Color::BLACK,                 // Beryllium,Be,4
    Color::BLACK,                 // Boron,B,5
    Color::rgb(0.25, 0.25, 0.25), // Carbon,C,6
    Color::rgb(0.16, 0.33, 0.70), // Nitrogen,N,7
    Color::rgb(1.00, 0.00, 0.00), // Oxygen,O,8
    Color::rgb(0.00, 1.00, 0.00), // Fluorine,F,9
    Color::CYAN,                  // Neon,Ne,10
    Color::BLACK,                 // Sodium,Na,11
    Color::BLACK,                 // Magnesium,Mg,12
    Color::BLACK,                 // Aluminium,Al,13
    Color::BLACK,                 // Silicon,Si,14
    Color::rgb(1.00, 0.50, 0.00), // Phosphorus,P,15
    Color::rgb(1.00, 0.73, 0.00), // Sulfur,S,16
    Color::rgb(0.00, 0.75, 0.00), // Chlorine,Cl,17
    Color::CYAN,                  // Argon,Ar,18
    ...
    Color::rgb(0.10, 0.00, 0.00), // Bromine,Br,35
    Color::CYAN,                  // Krypton,Kr,36
    ...
    Color::rgb(0.50, 0.00, 0.50), // Iodine,I,53
    Color::CYAN,                  // Xenon,Xe,54
...
pub const ELEMENTNAMES: [&str; 119] = [
    "VirtualSite",
    "Hydrogen",
    "Helium",
    "Lithium",
